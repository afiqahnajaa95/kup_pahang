...
@Component({
    selector: 'admin-wang-cagaran',
    moduleId: module.id,
    styleUrls: ['admin-wang-cagaran.component.css'],
    templateUrl: 'admin-wang-cagaran.component.html'
})

export class AdminWangCagaranComponent{
    id: string;
    new: number = 0;
    izin: number = 0;
    permit: number = 0;
